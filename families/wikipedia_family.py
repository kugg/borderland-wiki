...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'hy', 'new', 'pms', 'be', 'tl', 'ta', 'ht', 'te', 'tt', 'cy',
            'be-x-old', 'lv', 'sq', 'bs', 'br', 'jv', 'mg', 'mr', 'lb', 'is',
            'ml', 'my', 'ba', 'yo', 'an', 'lmo', 'fy', 'af', 'bn', 'pnb', 'sw',
            'bpy', 'zh-yue', 'io', 'ky', 'ur', 'ne', 'scn', 'gu', 'ga', 'nds',
            'ku', 'cv', 'ast', 'qu', 'su', 'sco', 'als', 'bug', 'ia', 'nap',
            'kn', 'bat-smg', 'map-bms', 'wa', 'am', 'gd', 'ckb', 'hif',
            'zh-min-nan', 'tg', 'arz', 'mzn', 'yi', 'vec', 'mn', 'sah', 'nah',
            'sa', 'roa-tara', 'os', 'si', 'pam', 'bar', 'hsb', 'se', 'pa', 'li',
            'mi', 'co', 'fo', 'ilo', 'gan', 'bo', 'glk', 'rue', 'frr', 'bcl',
            'nds-nl', 'fiu-vro', 'mrj', 'tk', 'ps', 'vls', 'xmf', 'gv', 'min',
            'diq', 'or', 'kv', 'pag', 'km', 'zea', 'mhr', 'dv', 'nrm', 'csb',
            'vep', 'rm', 'koi', 'ce', 'udm', 'lad', 'lij', 'wuu', 'fur',
            'zh-classical', 'sc', 'stq', 'ug', 'mt', 'ay', 'so', 'pi', 'hak',
            'bh', 'ksh', 'nov', 'kw', 'ang', 'gn', 'pcd', 'nv', 'as', 'ext',
            'eml', 'frp', 'gag', 'ace', 'szl', 'ie', 'ln', 'pfl', 'krc', 'xal',
            'haw', 'pdc', 'rw', 'crh', 'to', 'dsb', 'lez', 'arc', 'kl', 'myv',
            'kab', 'sn', 'bjn', 'pap', 'tpi', 'lbe', 'wo', 'mwl', 'jbo', 'mdf',
            'kbd', 'cbk-zam', 'av', 'srn', 'lo', 'ty', 'kg', 'ab', 'tet', 'ltg',
            'na', 'ig', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu',
            'tn', 'chr', 'roa-rup', 'cdo', 'bi', 'got', 'sm', 'bm', 'iu', 'pih',
