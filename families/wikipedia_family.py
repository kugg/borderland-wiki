...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'eu', 'lt', 'bg', 'he', 'hr', 'sl', 'uz', 'et', 'vo', 'sh',
            'nn', 'gl', 'hy', 'hi', 'simple', 'la', 'az', 'el', 'th', 'oc',
            'ka', 'mk', 'new', 'be', 'pms', 'tl', 'ta', 'tt', 'te', 'cy', 'ht',
            'lv', 'be-x-old', 'sq', 'bs', 'br', 'jv', 'mg', 'lb', 'mr', 'is',
            'ml', 'ba', 'my', 'yo', 'af', 'pnb', 'an', 'fy', 'lmo', 'tg', 'ga',
            'bn', 'ur', 'cv', 'zh-yue', 'ky', 'sw', 'io', 'ne', 'gu', 'bpy',
            'scn', 'ce', 'sco', 'nds', 'ku', 'ast', 'qu', 'su', 'als', 'am',
            'kn', 'ia', 'nap', 'bug', 'bat-smg', 'ckb', 'wa', 'map-bms', 'mn',
            'gd', 'hif', 'arz', 'mzn', 'zh-min-nan', 'yi', 'si', 'vec', 'sah',
            'sa', 'nah', 'bar', 'roa-tara', 'os', 'pa', 'pam', 'fo', 'hsb',
            'se', 'li', 'mi', 'ilo', 'co', 'gan', 'frr', 'bo', 'glk', 'rue',
            'bcl', 'or', 'nds-nl', 'fiu-vro', 'mrj', 'ps', 'tk', 'vls', 'xmf',
            'gv', 'pag', 'diq', 'zea', 'km', 'kv', 'mhr', 'csb', 'vep', 'hak',
            'dv', 'so', 'nrm', 'ay', 'rm', 'koi', 'udm', 'ug', 'stq', 'sc',
            'lad', 'zh-classical', 'wuu', 'lij', 'fur', 'mt', 'pi', 'eml',
            'nov', 'bh', 'as', 'ksh', 'gn', 'pcd', 'kw', 'gag', 'ang', 'ace',
            'szl', 'nv', 'ext', 'frp', 'ie', 'mwl', 'ln', 'sn', 'dsb', 'pfl',
            'lez', 'krc', 'crh', 'haw', 'pdc', 'xal', 'rw', 'kab', 'to', 'myv',
            'arc', 'kl', 'bjn', 'pap', 'kbd', 'lo', 'tpi', 'lbe', 'wo', 'jbo',
            'mdf', 'cbk-zam', 'av', 'srn', 'bxr', 'ty', 'kg', 'ab', 'na', 'tet',
            'ig', 'ltg', 'nso', 'za', 'kaa', 'zu', 'ha', 'chy', 'rmy', 'chr',
            'cu', 'tn', 'cdo', 'roa-rup', 'pih', 'bi', 'got', 'sm', 'tyv', 'bm',
            'iu', 'ss', 'sd', 'pnt', 'ki', 'tw', 'rn', 'ee', 'ts', 'om', 'ak',
            'fj', 'ti', 'ks', 'ff', 'sg', 've', 'st', 'cr', 'lg', 'dz', 'xh',
            'tum', 'ik', 'ny', 'ch',
        ]
