...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'dv', 'so', 'nrm', 'ay', 'rm', 'koi', 'udm', 'stq', 'ug', 'lad',
            'sc', 'wuu', 'zh-classical', 'lij', 'fur', 'mt', 'pi', 'eml', 'nov',
            'bh', 'as', 'ksh', 'gn', 'pcd', 'kw', 'gag', 'ang', 'ace', 'szl',
            'nv', 'ext', 'frp', 'ie', 'mwl', 'ln', 'sn', 'pfl', 'lez', 'dsb',
            'krc', 'haw', 'crh', 'pdc', 'xal', 'rw', 'kab', 'to', 'myv', 'arc',
            'kl', 'bjn', 'pap', 'kbd', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'srn', 'bxr', 'ty', 'kg', 'ab', 'na', 'tet', 'ig',
            'ltg', 'nso', 'za', 'kaa', 'zu', 'ha', 'chy', 'rmy', 'cu', 'chr',
            'tn', 'cdo', 'roa-rup', 'pih', 'bi', 'got', 'sm', 'bm', 'tyv', 'iu',
            'ss', 'sd', 'pnt', 'ki', 'tw', 'rn', 'ee', 'om', 'ak', 'fj', 'ti',
            'ts', 'ks', 'ff', 'sg', 've', 'st', 'cr', 'lg', 'dz', 'xh', 'tum',
            'ik', 'ny', 'ch',
        ]
