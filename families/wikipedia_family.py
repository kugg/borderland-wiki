...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'pt', 'zh', 'uk', 'ca', 'no', 'war', 'ceb', 'fi', 'fa', 'cs', 'hu',
            'ko', 'ar', 'ro', 'ms', 'tr', 'id', 'kk', 'sr', 'sk', 'eo', 'da',
            'lt', 'eu', 'bg', 'he', 'hr', 'sl', 'uz', 'vo', 'et', 'hi', 'nn',
            'gl', 'simple', 'az', 'la', 'el', 'oc', 'sh', 'th', 'ka', 'mk',
            ...
            'min', 'or', 'kv', 'pag', 'zea', 'km', 'dv', 'nrm', 'mhr', 'csb',
            'rm', 'koi', 'frr', 'vep', 'udm', 'lad', 'wuu', 'lij', 'fur',
            'zh-classical', 'sc', 'ug', 'stq', 'mt', 'ay', 'pi', 'so', 'bh',
            'ksh', 'nov', 'ce', 'hak', 'kw', 'ang', 'pcd', 'nv', 'gn', 'as',
            'ext', 'frp', 'ace', 'szl', 'eml', 'gag', 'ie', 'ln', 'krc', 'pfl',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'to', 'dsb', 'kl', 'arc', 'myv',
            'lez', 'kab', 'bjn', 'sn', 'pap', 'tpi', 'lbe', 'wo', 'mwl', 'jbo',
            'mdf', 'kbd', 'cbk-zam', 'av', 'srn', 'ty', 'lo', 'ab', 'kg', 'tet',
            'ltg', 'na', 'ig', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy',
            'cu', 'tn', 'chr', 'roa-rup', 'bi', 'cdo', 'got', 'sm', 'bm', 'iu',
            'pih', 'pnt', 'ss', 'sd', 'ki', 'ee', 'ha', 'om', 'fj', 'ti', 'ts',
