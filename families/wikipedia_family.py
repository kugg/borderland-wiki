...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ka', 'mk', 'new', 'be', 'pms', 'tl', 'ta', 'te', 'tt', 'ht', 'cy',
            'lv', 'be-x-old', 'sq', 'bs', 'br', 'mg', 'jv', 'lb', 'mr', 'is',
            'ml', 'my', 'ba', 'yo', 'pnb', 'an', 'af', 'lmo', 'fy', 'ga', 'bn',
            'zh-yue', 'ur', 'sw', 'io', 'bpy', 'gu', 'ne', 'ky', 'tg', 'scn',
            'nds', 'cv', 'ku', 'ast', 'sco', 'qu', 'su', 'ce', 'als', 'kn',
            ...
            'zh-classical', 'fur', 'stq', 'mt', 'ug', 'ay', 'so', 'pi', 'nov',
            'bh', 'ksh', 'gn', 'as', 'kw', 'eml', 'gag', 'pcd', 'ang', 'ace',
            'nv', 'szl', 'ext', 'frp', 'ie', 'mwl', 'ln', 'pfl', 'lez', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'dsb', 'sn', 'to', 'arc', 'kl',
            'myv', 'kab', 'bjn', 'pap', 'tpi', 'kbd', 'lo', 'lbe', 'wo', 'jbo',
            'mdf', 'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'na', 'bxr', 'tet',
