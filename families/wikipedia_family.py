...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sw', 'bpy', 'ur', 'io', 'ky', 'ne', 'scn', 'ga', 'gu', 'nds', 'ku',
            'cv', 'ast', 'qu', 'tg', 'su', 'sco', 'als', 'bug', 'ia', 'nap',
            'kn', 'bat-smg', 'map-bms', 'wa', 'am', 'ckb', 'gd', 'hif',
            ...
            'or', 'diq', 'kv', 'pag', 'km', 'zea', 'mhr', 'ce', 'dv', 'csb',
            'nrm', 'vep', 'rm', 'koi', 'udm', 'hak', 'lad', 'lij', 'wuu',
            'zh-classical', 'fur', 'sc', 'stq', 'mt', 'ug', 'ay', 'so', 'pi',
            'bh', 'ksh', 'nov', 'kw', 'gn', 'ang', 'pcd', 'nv', 'as', 'gag',
            'ext', 'eml', 'frp', 'ace', 'szl', 'ie', 'ln', 'pfl', 'krc', 'xal',
            'haw', 'pdc', 'rw', 'crh', 'lez', 'dsb', 'to', 'arc', 'kl', 'myv',
            'kab', 'sn', 'bjn', 'pap', 'tpi', 'lbe', 'lo', 'wo', 'mwl', 'jbo',
