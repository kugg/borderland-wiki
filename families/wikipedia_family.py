...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh-yue', 'ur', 'sw', 'tg', 'io', 'gu', 'ne', 'bpy', 'ky', 'scn',
            'ce', 'nds', 'ku', 'cv', 'ast', 'sco', 'qu', 'su', 'als', 'kn',
            'ia', 'bug', 'nap', 'bat-smg', 'am', 'ckb', 'wa', 'map-bms', 'gd',
            'mn', 'hif', 'arz', 'zh-min-nan', 'mzn', 'yi', 'vec', 'sah', 'nah',
            'sa', 'si', 'roa-tara', 'os', 'bar', 'pa', 'pam', 'hsb', 'se', 'li',
            ...
            'lij', 'fur', 'stq', 'so', 'mt', 'ug', 'ay', 'pi', 'nov', 'bh',
            'ksh', 'as', 'gn', 'eml', 'kw', 'pcd', 'gag', 'ang', 'ace', 'nv',
            'szl', 'ext', 'frp', 'ie', 'mwl', 'ln', 'sn', 'pfl', 'lez', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'dsb', 'to', 'kab', 'arc', 'myv',
            'kl', 'bjn', 'pap', 'kbd', 'tpi', 'lo', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'bxr', 'na', 'tet', 'ltg',
            'ig', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'cdo', 'tn',
            'chr', 'roa-rup', 'bi', 'got', 'pih', 'sm', 'bm', 'iu', 'ss', 'sd',
            'pnt', 'ki', 'tyv', 'ee', 'ha', 'om', 'fj', 'ti', 'ts', 'ks', 'tw',
            'sg', 've', 'ff', 'st', 'rn', 'cr', 'dz', 'ak', 'tum', 'ik', 'lg',
            'ny', 'ch', 'xh',
        ]
