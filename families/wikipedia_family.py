...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'nl', 'de', 'sv', 'fr', 'it', 'ru', 'es', 'war', 'vi', 'pl',
            ...
            'mt', 'eml', 'bh', 'as', 'nov', 'cbk-zam', 'pi', 'gn', 'ksh', 'pcd',
            'ang', 'gag', 'szl', 'nv', 'ie', 'ace', 'ext', 'frp', 'mwl', 'ln',
            'sn', 'dsb', 'lez', 'pfl', 'krc', 'haw', 'pdc', 'kab', 'xal', 'rw',
            'myv', 'to', 'arc', 'kl', 'bjn', 'kbd', 'pap', 'lo', 'tpi', 'lbe',
            'wo', 'av', 'mdf', 'jbo', 'na', 'bxr', 'ty', 'srn', 'ig', 'kg',
            'nso', 'tet', 'ab', 'kaa', 'ltg', 'za', 'zu', 'ha', 'chy', 'tyv',
