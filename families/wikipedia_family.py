...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'eu', 'lt', 'bg', 'he', 'sh', 'hr', 'sl', 'uz', 'et', 'vo',
            'hy', 'nn', 'gl', 'simple', 'hi', 'la', 'az', 'el', 'th', 'oc',
            'ka', 'mk', 'be', 'new', 'pms', 'tl', 'ta', 'te', 'tt', 'cy', 'lv',
            'ht', 'be-x-old', 'sq', 'bs', 'br', 'jv', 'mg', 'lb', 'mr', 'is',
            'ur', 'ml', 'pnb', 'ba', 'my', 'af', 'yo', 'an', 'ga', 'lmo', 'fy',
            ...
            'sa', 'pa', 'nah', 'bar', 'os', 'roa-tara', 'fo', 'pam', 'hsb',
            'se', 'li', 'mi', 'ilo', 'co', 'or', 'gan', 'frr', 'bo', 'glk',
            'rue', 'bcl', 'nds-nl', 'fiu-vro', 'mrj', 'tk', 'ps', 'vls', 'gv',
            'xmf', 'pag', 'diq', 'km', 'zea', 'kv', 'mhr', 'csb', 'vep', 'hak',
            'ay', 'dv', 'so', 'nrm', 'rm', 'koi', 'udm', 'sc', 'zh-classical',
            'ug', 'stq', 'lad', 'wuu', 'lij', 'fur', 'mt', 'eml', 'as', 'pi',
            'nov', 'bh', 'ksh', 'gn', 'pcd', 'kw', 'ang', 'gag', 'ace', 'szl',
            'nv', 'ext', 'ie', 'frp', 'mwl', 'sn', 'ln', 'dsb', 'pfl', 'crh',
            'lez', 'krc', 'pdc', 'haw', 'xal', 'kab', 'rw', 'to', 'myv', 'arc',
            'kl', 'bjn', 'kbd', 'pap', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'ty', 'srn', 'ig', 'bxr', 'kg', 'ab', 'na', 'tet',
            'ltg', 'nso', 'za', 'kaa', 'zu', 'ha', 'chy', 'rmy', 'cu', 'chr',
            'tn', 'cdo', 'roa-rup', 'bi', 'pih', 'got', 'tyv', 'sm', 'tw', 'bm',
