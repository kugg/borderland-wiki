...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'be-x-old', 'ht', 'ur', 'bs', 'sq', 'br', 'jv', 'mg', 'ce', 'lb',
            'mr', 'is', 'ml', 'pnb', 'ba', 'af', 'my', 'lmo', 'zh-yue', 'ga',
            'yo', 'bn', 'fy', 'an', 'cv', 'tg', 'ky', 'sw', 'ne', 'io', 'gu',
            'bpy', 'sco', 'scn', 'nds', 'ku', 'ast', 'qu', 'su', 'als', 'gd',
            'kn', 'am', 'ia', 'nap', 'ckb', 'bug', 'bat-smg', 'wa', 'map-bms',
            'mn', 'arz', 'mzn', 'si', 'zh-min-nan', 'pa', 'yi', 'sah', 'vec',
            ...
            'vep', 'ay', 'dv', 'sc', 'so', 'zh-classical', 'nrm', 'rm', 'udm',
            'koi', 'ug', 'kw', 'stq', 'lad', 'wuu', 'lij', 'fur', 'eml', 'mt',
            'bh', 'as', 'cbk-zam', 'gn', 'pi', 'gag', 'pcd', 'ksh', 'nov',
            'szl', 'ang', 'nv', 'ie', 'ace', 'ext', 'frp', 'mwl', 'ln', 'sn',
            'dsb', 'lez', 'pfl', 'krc', 'haw', 'pdc', 'xal', 'kab', 'rw', 'myv',
            'to', 'arc', 'kl', 'bjn', 'kbd', 'ha', 'pap', 'lo', 'tpi', 'lbe',
            'av', 'mdf', 'jbo', 'wo', 'na', 'bxr', 'ty', 'srn', 'ig', 'nso',
            'kg', 'tet', 'kaa', 'ab', 'ltg', 'zu', 'za', 'tyv', 'chy', 'rmy',
            'cdo', 'cu', 'chr', 'tn', 'roa-rup', 'tw', 'got', 'bi', 'pih', 'sm',
