...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'eu', 'sh', 'lt', 'bg', 'he', 'hr', 'sl', 'uz', 'et', 'vo',
            'hy', 'nn', 'gl', 'simple', 'hi', 'la', 'az', 'el', 'th', 'oc',
            'ka', 'mk', 'be', 'new', 'pms', 'tl', 'ta', 'tt', 'cy', 'te', 'lv',
            'ht', 'be-x-old', 'ur', 'sq', 'bs', 'br', 'jv', 'mg', 'lb', 'mr',
            'is', 'ml', 'pnb', 'ba', 'my', 'ce', 'af', 'yo', 'ga', 'zh-yue',
            'bn', 'an', 'fy', 'tg', 'lmo', 'cv', 'ky', 'sw', 'io', 'ne', 'gu',
            'bpy', 'scn', 'sco', 'nds', 'ku', 'ast', 'qu', 'su', 'als', 'kn',
            'am', 'gd', 'ia', 'nap', 'bug', 'ckb', 'bat-smg', 'wa', 'map-bms',
            'mn', 'arz', 'mzn', 'zh-min-nan', 'si', 'yi', 'pa', 'vec', 'sah',
            'sa', 'nah', 'bar', 'fo', 'os', 'roa-tara', 'pam', 'hsb', 'or',
            'se', 'li', 'mi', 'ilo', 'co', 'hif', 'gan', 'frr', 'bo', 'glk',
            'rue', 'bcl', 'mhr', 'nds-nl', 'fiu-vro', 'mrj', 'ps', 'tk', 'vls',
            'gv', 'xmf', 'pag', 'diq', 'km', 'zea', 'kv', 'csb', 'crh', 'vep',
            'hak', 'ay', 'dv', 'so', 'nrm', 'rm', 'sc', 'udm', 'zh-classical',
            'koi', 'kw', 'ug', 'stq', 'lad', 'wuu', 'lij', 'fur', 'mt', 'eml',
            'as', 'pi', 'bh', 'gn', 'nov', 'ksh', 'pcd', 'ang', 'gag', 'szl',
            'nv', 'ace', 'ie', 'ext', 'frp', 'mwl', 'sn', 'ln', 'dsb', 'pfl',
            'lez', 'krc', 'haw', 'pdc', 'xal', 'kab', 'rw', 'to', 'myv', 'arc',
            'kl', 'bjn', 'kbd', 'pap', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'av',
            'mdf', 'cbk-zam', 'ty', 'srn', 'bxr', 'ig', 'kg', 'na', 'tet', 'ab',
            'ltg', 'nso', 'kaa', 'za', 'zu', 'ha', 'chy', 'rmy', 'cu', 'chr',
            'tyv', 'tn', 'cdo', 'roa-rup', 'bi', 'got', 'pih', 'tw', 'sm', 'bm',
            'ss', 'iu', 'sd', 'pnt', 'ki', 'rn', 'xh', 'om', 'ts', 'ee', 'ak',
