...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ko', 'hu', 'ar', 'ms', 'ro', 'sr', 'min', 'tr', 'kk', 'eo', 'sk',
            ...
            'ml', 'my', 'ba', 'yo', 'an', 'af', 'pnb', 'lmo', 'fy', 'ga', 'bn',
            'zh-yue', 'ur', 'sw', 'io', 'bpy', 'ne', 'ky', 'gu', 'scn', 'tg',
            'nds', 'ku', 'cv', 'ast', 'qu', 'sco', 'su', 'als', 'kn', 'ia',
            'bug', 'nap', 'bat-smg', 'ckb', 'am', 'wa', 'map-bms', 'ce', 'gd',
            ...
            'ksh', 'gn', 'gag', 'kw', 'ang', 'as', 'eml', 'pcd', 'ace', 'nv',
            'szl', 'ext', 'frp', 'ie', 'mwl', 'ln', 'pfl', 'lez', 'krc', 'xal',
            'haw', 'pdc', 'rw', 'crh', 'dsb', 'to', 'sn', 'arc', 'kl', 'myv',
            'kab', 'bjn', 'pap', 'tpi', 'kbd', 'lo', 'lbe', 'wo', 'mdf', 'jbo',
            'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'na', 'tet', 'bxr', 'ltg',
            'ig', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'tn', 'chr',
