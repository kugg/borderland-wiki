...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ast', 'qu', 'su', 'cv', 'sco', 'als', 'ia', 'nap', 'bug',
            'bat-smg', 'kn', 'map-bms', 'wa', 'am', 'ckb', 'gd', 'hif',
            'zh-min-nan', 'tg', 'arz', 'mzn', 'yi', 'vec', 'mn', 'sah', 'nah',
            'roa-tara', 'sa', 'os', 'pam', 'hsb', 'si', 'bar', 'se', 'li', 'mi',
            'co', 'pa', 'fo', 'ilo', 'gan', 'bo', 'glk', 'rue', 'bcl',
            'fiu-vro', 'mrj', 'nds-nl', 'tk', 'ps', 'vls', 'xmf', 'gv', 'diq',
            'min', 'or', 'kv', 'pag', 'km', 'zea', 'dv', 'nrm', 'mhr', 'rm',
            'koi', 'csb', 'udm', 'frr', 'vep', 'lad', 'wuu', 'lij', 'fur',
            'zh-classical', 'sc', 'ug', 'stq', 'ay', 'mt', 'pi', 'so', 'bh',
            'ksh', 'nov', 'hak', 'ang', 'kw', 'pcd', 'nv', 'gn', 'ext', 'as',
            'ce', 'frp', 'szl', 'eml', 'ace', 'gag', 'ie', 'ln', 'pfl', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'to', 'dsb', 'kl', 'arc', 'myv',
            'lez', 'kab', 'bjn', 'sn', 'pap', 'tpi', 'lbe', 'wo', 'mwl', 'jbo',
            'cbk-zam', 'mdf', 'av', 'kbd', 'srn', 'ty', 'lo', 'ab', 'kg', 'tet',
