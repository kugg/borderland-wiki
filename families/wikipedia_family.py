...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ml', 'my', 'ba', 'yo', 'pnb', 'af', 'an', 'lmo', 'fy', 'ga', 'bn',
            'zh-yue', 'tg', 'ur', 'sw', 'ky', 'io', 'gu', 'ne', 'bpy', 'scn',
            ...
            'nrm', 'rm', 'koi', 'udm', 'lad', 'sc', 'wuu', 'zh-classical',
            'lij', 'ug', 'fur', 'so', 'stq', 'mt', 'ay', 'pi', 'nov', 'bh',
            'ksh', 'as', 'eml', 'gn', 'kw', 'pcd', 'gag', 'ang', 'ace', 'nv',
            'szl', 'ext', 'frp', 'ie', 'mwl', 'ln', 'sn', 'pfl', 'lez', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'dsb', 'kab', 'to', 'myv', 'arc',
            'kl', 'bjn', 'pap', 'kbd', 'tpi', 'lo', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'srn', 'ty', 'kg', 'bxr', 'ab', 'na', 'tet', 'ltg',
            'ig', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'cdo', 'tn',
            'chr', 'roa-rup', 'bi', 'pih', 'got', 'sm', 'bm', 'iu', 'ss', 'sd',
            'pnt', 'ki', 'tyv', 'ee', 'ha', 'om', 'fj', 'ti', 'ts', 'ks', 'tw',
            'sg', 've', 'ff', 'st', 'cr', 'rn', 'dz', 'ak', 'tum', 'ik', 'lg',
            'ny', 'ch', 'xh',
        ]
