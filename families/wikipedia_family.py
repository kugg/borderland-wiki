...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'zh-min-nan', 'arz', 'mzn', 'mn', 'yi', 'vec', 'sah', 'nah', 'sa',
            'roa-tara', 'os', 'si', 'bar', 'pam', 'hsb', 'se', 'pa', 'li', 'mi',
            ...
            'bh', 'ksh', 'nov', 'gn', 'kw', 'ang', 'pcd', 'gag', 'nv', 'as',
            'eml', 'ext', 'frp', 'ace', 'szl', 'mwl', 'ie', 'ln', 'pfl', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'lez', 'dsb', 'to', 'arc', 'kl',
            'myv', 'kab', 'sn', 'bjn', 'pap', 'tpi', 'lo', 'lbe', 'wo', 'jbo',
            'mdf', 'kbd', 'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'tet',
            'ltg', 'ig', 'na', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy',
            'cu', 'chr', 'tn', 'cdo', 'roa-rup', 'bi', 'got', 'sm', 'pih', 'bm',
            'iu', 'pnt', 'sd', 'ss', 'ki', 'ee', 'ha', 'tyv', 'om', 'fj', 'ti',
