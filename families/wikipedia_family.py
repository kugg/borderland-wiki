...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'gl', 'hi', 'hy', 'simple', 'la', 'sh', 'az', 'el', 'oc', 'th',
            ...
            'cv', 'ce', 'nds', 'sco', 'ku', 'ast', 'qu', 'su', 'als', 'am',
            'kn', 'ia', 'bug', 'nap', 'bat-smg', 'ckb', 'wa', 'map-bms', 'mn',
            'gd', 'hif', 'arz', 'mzn', 'zh-min-nan', 'yi', 'vec', 'si', 'sah',
            'sa', 'nah', 'bar', 'roa-tara', 'os', 'pa', 'pam', 'hsb', 'fo',
            'se', 'li', 'mi', 'ilo', 'co', 'gan', 'frr', 'bo', 'glk', 'rue',
            'bcl', 'nds-nl', 'or', 'fiu-vro', 'mrj', 'ps', 'tk', 'vls', 'xmf',
            'gv', 'diq', 'zea', 'km', 'kv', 'mhr', 'csb', 'pag', 'vep', 'hak',
            'dv', 'so', 'nrm', 'rm', 'ay', 'koi', 'udm', 'stq', 'lad', 'sc',
            'wuu', 'ug', 'zh-classical', 'lij', 'fur', 'mt', 'pi', 'eml', 'nov',
            'bh', 'as', 'ksh', 'gn', 'pcd', 'kw', 'ang', 'gag', 'ace', 'szl',
            'nv', 'ext', 'frp', 'ie', 'mwl', 'ln', 'sn', 'pfl', 'lez', 'krc',
            'haw', 'crh', 'xal', 'pdc', 'dsb', 'rw', 'kab', 'to', 'myv', 'arc',
            'kl', 'bjn', 'pap', 'kbd', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'srn', 'bxr', 'ty', 'kg', 'ab', 'na', 'tet', 'ig',
            'ltg', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'chr', 'tn',
            'cdo', 'roa-rup', 'bi', 'pih', 'got', 'ha', 'sm', 'bm', 'iu', 'ss',
            'sd', 'pnt', 'tyv', 'ki', 'rn', 'ee', 'om', 'ak', 'fj', 'ti', 'tw',
            'ts', 'ks', 'ff', 'sg', 've', 'st', 'cr', 'dz', 'lg', 'xh', 'tum',
            'ik', 'ny', 'ch',
        ]
