...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'nl', 'de', 'fr', 'it', 'sv', 'es', 'ru', 'pl', 'ja', 'pt',
            'vi', 'zh', 'uk', 'ca', 'no', 'war', 'ceb', 'fi', 'fa', 'cs', 'hu',
            'ko', 'ar', 'ro', 'ms', 'tr', 'id', 'kk', 'sr', 'sk', 'eo', 'da',
            'lt', 'eu', 'bg', 'he', 'hr', 'sl', 'uz', 'vo', 'et', 'hi', 'nn',
            'gl', 'simple', 'az', 'la', 'el', 'sh', 'th', 'ka', 'oc', 'mk',
            'new', 'pms', 'tl', 'be', 'ta', 'ht', 'te', 'be-x-old', 'lv', 'cy',
            'hy', 'bs', 'br', 'sq', 'tt', 'jv', 'mg', 'mr', 'lb', 'is', 'my',
            'ml', 'ba', 'yo', 'an', 'lmo', 'af', 'fy', 'pnb', 'bn', 'sw', 'bpy',
            'io', 'ky', 'ur', 'ne', 'zh-yue', 'scn', 'gu', 'nds', 'ga', 'ku',
            'ast', 'qu', 'cv', 'su', 'sco', 'als', 'ia', 'nap', 'bug',
            'bat-smg', 'kn', 'map-bms', 'wa', 'am', 'ckb', 'gd', 'hif',
            'zh-min-nan', 'tg', 'arz', 'mzn', 'yi', 'vec', 'sah', 'mn', 'nah',
            'roa-tara', 'sa', 'os', 'pam', 'hsb', 'si', 'bar', 'se', 'li', 'mi',
            'pa', 'co', 'fo', 'ilo', 'gan', 'bo', 'glk', 'rue', 'bcl',
            'fiu-vro', 'mrj', 'nds-nl', 'tk', 'ps', 'vls', 'xmf', 'gv', 'diq',
            'min', 'or', 'kv', 'pag', 'zea', 'km', 'dv', 'nrm', 'mhr', 'rm',
            'csb', 'koi', 'udm', 'vep', 'frr', 'lad', 'wuu', 'lij', 'fur',
            'zh-classical', 'sc', 'ug', 'stq', 'mt', 'ay', 'pi', 'so', 'bh',
            'ksh', 'nov', 'ce', 'hak', 'ang', 'kw', 'pcd', 'nv', 'gn', 'ext',
            'as', 'frp', 'szl', 'ace', 'eml', 'gag', 'ie', 'ln', 'pfl', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'to', 'dsb', 'kl', 'arc', 'myv',
            'lez', 'kab', 'bjn', 'sn', 'pap', 'tpi', 'lbe', 'wo', 'mwl', 'jbo',
            'mdf', 'cbk-zam', 'kbd', 'av', 'srn', 'ty', 'lo', 'ab', 'kg', 'tet',
            'ltg', 'na', 'ig', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy',
            'cu', 'tn', 'chr', 'roa-rup', 'bi', 'cdo', 'got', 'sm', 'bm', 'iu',
            'pih', 'pnt', 'sd', 'ss', 'ki', 'ee', 'ha', 'om', 'fj', 'ti', 'ts',
            'ks', 've', 'sg', 'rn', 'st', 'cr', 'ak', 'dz', 'tum', 'lg', 'ff',
            'ik', 'ny', 'ch', 'tw', 'xh',
        ]
