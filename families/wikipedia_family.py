...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'da', 'eu', 'lt', 'bg', 'he', 'hr', 'sl', 'uz', 'et', 'vo', 'hi',
            'gl', 'nn', 'simple', 'hy', 'la', 'az', 'el', 'sh', 'oc', 'th',
            'ka', 'mk', 'new', 'be', 'pms', 'tl', 'ta', 'tt', 'te', 'ht', 'cy',
            'lv', 'be-x-old', 'sq', 'bs', 'br', 'mg', 'jv', 'lb', 'mr', 'is',
            'ml', 'my', 'ba', 'yo', 'pnb', 'af', 'an', 'lmo', 'fy', 'ga', 'tg',
            'bn', 'zh-yue', 'ur', 'sw', 'ky', 'io', 'ne', 'gu', 'bpy', 'scn',
            'ce', 'nds', 'cv', 'ku', 'sco', 'ast', 'qu', 'su', 'als', 'kn',
            'ia', 'bug', 'nap', 'bat-smg', 'am', 'ckb', 'wa', 'map-bms', 'gd',
            'mn', 'hif', 'arz', 'zh-min-nan', 'mzn', 'yi', 'vec', 'sah', 'nah',
            'sa', 'si', 'roa-tara', 'bar', 'os', 'pa', 'pam', 'hsb', 'se', 'li',
            'fo', 'mi', 'co', 'ilo', 'gan', 'bo', 'frr', 'glk', 'rue', 'bcl',
            'nds-nl', 'fiu-vro', 'or', 'mrj', 'tk', 'ps', 'vls', 'xmf', 'gv',
            'diq', 'zea', 'kv', 'km', 'mhr', 'pag', 'csb', 'vep', 'dv', 'hak',
            'nrm', 'rm', 'koi', 'udm', 'lad', 'sc', 'so', 'wuu', 'zh-classical',
            'lij', 'ug', 'ay', 'fur', 'stq', 'mt', 'pi', 'nov', 'bh', 'ksh',
            'as', 'eml', 'gn', 'kw', 'pcd', 'gag', 'ang', 'ace', 'nv', 'szl',
            'ext', 'frp', 'ie', 'mwl', 'ln', 'sn', 'pfl', 'lez', 'krc', 'xal',
            'haw', 'pdc', 'crh', 'rw', 'dsb', 'kab', 'to', 'myv', 'arc', 'kl',
            'bjn', 'pap', 'kbd', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'srn', 'ty', 'kg', 'bxr', 'ab', 'na', 'tet', 'ltg',
            'ig', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'tn', 'cdo',
            'chr', 'roa-rup', 'bi', 'pih', 'got', 'sm', 'bm', 'iu', 'ss', 'sd',
            'pnt', 'ki', 'tyv', 'ee', 'ha', 'om', 'fj', 'ti', 'rn', 'ts', 'ak',
            'ks', 'tw', 'sg', 'ff', 've', 'st', 'cr', 'dz', 'tum', 'ik', 'xh',
            'lg', 'ny', 'ch',
        ]
