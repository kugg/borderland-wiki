...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'bs', 'br', 'sq', 'hy', 'mg', 'tt', 'jv', 'mr', 'lb', 'is', 'my',
            'yo', 'ml', 'ba', 'an', 'lmo', 'af', 'fy', 'pnb', 'bn', 'sw', 'bpy',
            'io', 'ky', 'ur', 'ne', 'scn', 'zh-yue', 'gu', 'nds', 'ga', 'ku',
            'ast', 'qu', 'su', 'cv', 'sco', 'als', 'ia', 'nap', 'bug',
            'bat-smg', 'kn', 'map-bms', 'wa', 'am', 'ckb', 'gd', 'hif',
            'zh-min-nan', 'tg', 'arz', 'mzn', 'yi', 'vec', 'mn', 'nah',
            'roa-tara', 'sah', 'sa', 'os', 'pam', 'hsb', 'si', 'se', 'bar',
            'li', 'mi', 'co', 'gan', 'fo', 'ilo', 'bo', 'pa', 'glk', 'rue',
            'bcl', 'fiu-vro', 'mrj', 'nds-nl', 'tk', 'ps', 'vls', 'xmf', 'gv',
            'diq', 'min', 'or', 'kv', 'pag', 'zea', 'km', 'dv', 'nrm', 'mhr',
            'rm', 'koi', 'udm', 'csb', 'frr', 'vep', 'lad', 'lij', 'wuu', 'fur',
            'zh-classical', 'ug', 'sc', 'stq', 'ay', 'mt', 'pi', 'so', 'bh',
            'ksh', 'nov', 'ang', 'hak', 'kw', 'nv', 'pcd', 'gn', 'ext', 'frp',
            'as', 'szl', 'gag', 'eml', 'ie', 'ln', 'ace', 'ce', 'krc', 'pfl',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'to', 'dsb', 'kl', 'arc', 'myv',
            'kab', 'lez', 'bjn', 'sn', 'pap', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'kbd', 'srn', 'mwl', 'ty', 'lo', 'ab', 'tet',
