...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ja', 'vi', 'pt', 'zh', 'uk', 'ca', 'no', 'fa', 'fi', 'id', 'cs',
            'ko', 'hu', 'ar', 'ms', 'ro', 'sr', 'tr', 'min', 'kk', 'eo', 'sk',
            'da', 'eu', 'lt', 'bg', 'he', 'hr', 'sl', 'uz', 'vo', 'et', 'hi',
            'gl', 'simple', 'nn', 'hy', 'la', 'az', 'el', 'sh', 'oc', 'th',
            'ka', 'mk', 'new', 'be', 'pms', 'tl', 'ta', 'tt', 'te', 'ht', 'cy',
            'lv', 'be-x-old', 'sq', 'bs', 'br', 'mg', 'jv', 'lb', 'mr', 'is',
            'ml', 'my', 'ba', 'yo', 'pnb', 'an', 'af', 'lmo', 'fy', 'ga', 'bn',
            'zh-yue', 'ur', 'sw', 'io', 'bpy', 'ne', 'gu', 'ky', 'tg', 'scn',
            'nds', 'ce', 'cv', 'ku', 'ast', 'sco', 'qu', 'su', 'als', 'kn',
            'ia', 'bug', 'nap', 'bat-smg', 'am', 'ckb', 'wa', 'map-bms', 'gd',
            'mn', 'hif', 'arz', 'zh-min-nan', 'mzn', 'yi', 'vec', 'sah', 'nah',
            'sa', 'si', 'roa-tara', 'os', 'bar', 'pam', 'pa', 'hsb', 'se', 'li',
            'fo', 'mi', 'co', 'ilo', 'gan', 'bo', 'frr', 'glk', 'rue', 'bcl',
            'nds-nl', 'fiu-vro', 'mrj', 'or', 'tk', 'ps', 'vls', 'xmf', 'gv',
            'diq', 'zea', 'kv', 'km', 'mhr', 'pag', 'csb', 'vep', 'dv', 'hak',
            'nrm', 'rm', 'koi', 'udm', 'lad', 'wuu', 'sc', 'lij',
            'zh-classical', 'fur', 'stq', 'mt', 'ug', 'so', 'ay', 'pi', 'nov',
            'bh', 'ksh', 'gn', 'as', 'kw', 'eml', 'gag', 'pcd', 'ang', 'ace',
            'nv', 'szl', 'ext', 'frp', 'ie', 'mwl', 'ln', 'pfl', 'lez', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'sn', 'dsb', 'to', 'arc', 'kl',
            'kab', 'myv', 'bjn', 'pap', 'kbd', 'tpi', 'lo', 'lbe', 'wo', 'jbo',
            'mdf', 'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'bxr', 'na', 'tet',
            'ltg', 'ig', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'cdo',
            'tn', 'chr', 'roa-rup', 'bi', 'got', 'pih', 'sm', 'bm', 'iu', 'ss',
            'sd', 'pnt', 'ki', 'tyv', 'ee', 'ha', 'om', 'fj', 'ti', 'ts', 'ks',
            'tw', 'sg', 've', 'ff', 'st', 'rn', 'cr', 'dz', 'ak', 'tum', 'ik',
            'lg', 'ny', 'ch', 'xh',
        ]
