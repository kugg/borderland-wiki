...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'is', 'ml', 'my', 'ba', 'yo', 'an', 'af', 'lmo', 'fy', 'pnb', 'ga',
            'bn', 'zh-yue', 'ur', 'sw', 'bpy', 'io', 'ne', 'ky', 'gu', 'scn',
            'tg', 'nds', 'ku', 'cv', 'ast', 'qu', 'sco', 'su', 'als', 'kn',
            'ia', 'bug', 'nap', 'bat-smg', 'am', 'ckb', 'map-bms', 'wa', 'gd',
            'hif', 'mn', 'arz', 'zh-min-nan', 'mzn', 'yi', 'vec', 'sah', 'nah',
            'sa', 'roa-tara', 'si', 'os', 'bar', 'pam', 'hsb', 'pa', 'se', 'li',
            'mi', 'fo', 'co', 'ilo', 'gan', 'bo', 'frr', 'glk', 'rue', 'bcl',
            'ce', 'nds-nl', 'fiu-vro', 'mrj', 'tk', 'ps', 'vls', 'xmf', 'gv',
            'or', 'diq', 'zea', 'kv', 'km', 'pag', 'mhr', 'csb', 'dv', 'vep',
            'nrm', 'hak', 'rm', 'koi', 'udm', 'lad', 'wuu', 'lij',
            'zh-classical', 'sc', 'fur', 'stq', 'mt', 'ug', 'ay', 'so', 'pi',
            'nov', 'bh', 'ksh', 'gn', 'gag', 'kw', 'ang', 'pcd', 'as', 'eml',
            'ace', 'nv', 'szl', 'ext', 'frp', 'ie', 'mwl', 'ln', 'pfl', 'lez',
            'krc', 'xal', 'haw', 'pdc', 'rw', 'crh', 'dsb', 'to', 'arc', 'kl',
            'myv', 'kab', 'sn', 'bjn', 'pap', 'tpi', 'kbd', 'lo', 'lbe', 'wo',
            'mdf', 'jbo', 'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'na', 'tet',
            'ltg', 'ig', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu',
            'tn', 'chr', 'cdo', 'roa-rup', 'bi', 'got', 'pih', 'sm', 'bm', 'iu',
            'ss', 'sd', 'pnt', 'ki', 'tyv', 'ee', 'ha', 'om', 'fj', 'ti', 'ts',
            'ks', 'tw', 'sg', 've', 'st', 'rn', 'cr', 'dz', 'ak', 'tum', 'ff',
            'ik', 'lg', 'ny', 'ch', 'xh',
        ]
