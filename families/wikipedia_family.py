...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ko', 'hu', 'ar', 'ro', 'ms', 'sr', 'tr', 'kk', 'sk', 'eo', 'da',
            'lt', 'eu', 'bg', 'he', 'hr', 'sl', 'uz', 'vo', 'et', 'hi', 'gl',
            'nn', 'simple', 'hy', 'la', 'az', 'el', 'sh', 'oc', 'th', 'ka',
            'mk', 'new', 'be', 'pms', 'tl', 'ta', 'te', 'ht', 'tt', 'be-x-old',
            'cy', 'lv', 'sq', 'mg', 'bs', 'br', 'jv', 'mr', 'lb', 'is', 'ml',
            'my', 'ba', 'yo', 'an', 'lmo', 'fy', 'af', 'pnb', 'bn', 'zh-yue',
            'sw', 'ur', 'bpy', 'io', 'ky', 'ne', 'ga', 'scn', 'gu', 'tg', 'nds',
            'ku', 'cv', 'ast', 'qu', 'su', 'sco', 'als', 'ia', 'bug', 'nap',
            'kn', 'bat-smg', 'am', 'map-bms', 'wa', 'ckb', 'gd', 'hif',
            'zh-min-nan', 'arz', 'mn', 'mzn', 'yi', 'vec', 'sah', 'nah', 'sa',
            'roa-tara', 'os', 'si', 'bar', 'pam', 'hsb', 'pa', 'se', 'li', 'mi',
            'fo', 'co', 'ilo', 'gan', 'bo', 'frr', 'glk', 'rue', 'bcl',
            'nds-nl', 'fiu-vro', 'mrj', 'tk', 'ps', 'vls', 'xmf', 'gv', 'min',
            'or', 'ce', 'diq', 'kv', 'zea', 'km', 'pag', 'mhr', 'csb', 'dv',
            'vep', 'nrm', 'rm', 'hak', 'koi', 'udm', 'lad', 'lij', 'wuu',
            'zh-classical', 'sc', 'fur', 'stq', 'mt', 'ug', 'ay', 'so', 'pi',
            'bh', 'nov', 'ksh', 'gn', 'kw', 'ang', 'gag', 'pcd', 'nv', 'as',
            'eml', 'ext', 'ace', 'frp', 'szl', 'mwl', 'ie', 'ln', 'pfl', 'krc',
            'xal', 'haw', 'pdc', 'lez', 'rw', 'crh', 'dsb', 'to', 'arc', 'kl',
            'myv', 'kab', 'sn', 'bjn', 'pap', 'tpi', 'lo', 'lbe', 'wo', 'jbo',
            'mdf', 'kbd', 'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'na', 'tet',
            'ltg', 'ig', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu',
            'chr', 'tn', 'cdo', 'roa-rup', 'bi', 'got', 'pih', 'sm', 'iu', 'bm',
