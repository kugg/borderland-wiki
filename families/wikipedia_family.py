...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'pt', 'zh', 'ceb', 'war', 'uk', 'ca', 'no', 'fi', 'fa', 'cs', 'ko',
            ...
            'hy', 'tt', 'bs', 'br', 'sq', 'jv', 'mg', 'mr', 'lb', 'is', 'ml',
            ...
            'fiu-vro', 'mrj', 'nds-nl', 'tk', 'ps', 'vls', 'xmf', 'gv', 'min',
            'diq', 'or', 'kv', 'pag', 'km', 'zea', 'dv', 'mhr', 'nrm', 'csb',
            'rm', 'vep', 'koi', 'udm', 'lad', 'lij', 'wuu', 'ce', 'fur', 'sc',
            'zh-classical', 'stq', 'ug', 'mt', 'ay', 'so', 'pi', 'bh', 'ksh',
            'nov', 'hak', 'kw', 'ang', 'pcd', 'nv', 'gn', 'as', 'ext', 'frp',
            'ace', 'eml', 'gag', 'szl', 'ie', 'ln', 'krc', 'pfl', 'xal', 'haw',
            'pdc', 'rw', 'crh', 'to', 'dsb', 'arc', 'kl', 'lez', 'myv', 'kab',
