...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'nl', 'de', 'sv', 'fr', 'it', 'ru', 'es', 'pl', 'war', 'vi',
            'ja', 'ceb', 'pt', 'zh', 'uk', 'ca', 'no', 'fa', 'fi', 'id', 'cs',
            'ar', 'ko', 'ms', 'hu', 'sr', 'ro', 'tr', 'min', 'kk', 'eo', 'sk',
            'da', 'eu', 'sh', 'lt', 'bg', 'he', 'hr', 'sl', 'uz', 'et', 'hy',
            'vo', 'nn', 'gl', 'simple', 'hi', 'la', 'el', 'az', 'th', 'oc',
            'ka', 'mk', 'be', 'new', 'pms', 'tl', 'tt', 'ta', 'cy', 'te', 'lv',
            'be-x-old', 'ht', 'ur', 'sq', 'bs', 'br', 'jv', 'mg', 'lb', 'mr',
            'is', 'ce', 'ml', 'pnb', 'ba', 'my', 'af', 'yo', 'ga', 'bn',
            'zh-yue', 'an', 'lmo', 'fy', 'cv', 'tg', 'ky', 'sw', 'ne', 'io',
            'gu', 'bpy', 'sco', 'scn', 'nds', 'ku', 'ast', 'qu', 'su', 'als',
            'gd', 'kn', 'am', 'ia', 'nap', 'bug', 'ckb', 'bat-smg', 'wa',
            'map-bms', 'mn', 'arz', 'mzn', 'zh-min-nan', 'si', 'yi', 'pa',
            'vec', 'sah', 'sa', 'fo', 'nah', 'bar', 'os', 'roa-tara', 'pam',
            'hsb', 'or', 'se', 'li', 'mrj', 'mi', 'ilo', 'co', 'hif', 'gan',
            'frr', 'bo', 'rue', 'glk', 'mhr', 'bcl', 'nds-nl', 'fiu-vro', 'ps',
            'tk', 'vls', 'gv', 'xmf', 'pag', 'diq', 'km', 'kv', 'zea', 'csb',
            'crh', 'vep', 'hak', 'ay', 'dv', 'so', 'sc', 'nrm', 'zh-classical',
            'rm', 'udm', 'koi', 'kw', 'ug', 'stq', 'lad', 'wuu', 'lij', 'fur',
            'mt', 'eml', 'bh', 'as', 'nov', 'pi', 'gn', 'ksh', 'pcd', 'ang',
            'gag', 'szl', 'cbk-zam', 'nv', 'ie', 'ace', 'ext', 'frp', 'mwl',
            'ln', 'sn', 'dsb', 'lez', 'pfl', 'krc', 'haw', 'pdc', 'kab', 'xal',
            'rw', 'myv', 'to', 'arc', 'kl', 'bjn', 'kbd', 'pap', 'lo', 'tpi',
            'lbe', 'wo', 'av', 'mdf', 'jbo', 'bxr', 'ty', 'srn', 'ig', 'na',
            'kg', 'tet', 'ab', 'kaa', 'ltg', 'nso', 'za', 'zu', 'ha', 'chy',
            'rmy', 'tyv', 'cu', 'chr', 'tn', 'cdo', 'roa-rup', 'bi', 'got',
            'tw', 'pih', 'sm', 'ss', 'bm', 'iu', 'sd', 'pnt', 'ki', 'xh', 'rn',
            'ts', 'om', 'ee', 'ak', 'fj', 'ti', 'ks', 'sg', 'lg', 'ff', 've',
            'cr', 'st', 'dz', 'tum', 'ik', 'ny', 'ch',
        ]
