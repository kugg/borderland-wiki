...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ml', 'ba', 'my', 'yo', 'pnb', 'af', 'an', 'lmo', 'fy', 'ga', 'tg',
            'bn', 'zh-yue', 'ur', 'ky', 'sw', 'io', 'gu', 'ne', 'bpy', 'scn',
            'ce', 'nds', 'cv', 'ku', 'sco', 'ast', 'qu', 'su', 'als', 'kn',
            'ia', 'bug', 'nap', 'bat-smg', 'am', 'ckb', 'wa', 'map-bms', 'gd',
            'mn', 'hif', 'arz', 'mzn', 'zh-min-nan', 'yi', 'vec', 'sah', 'sa',
            'nah', 'si', 'roa-tara', 'bar', 'os', 'pa', 'pam', 'hsb', 'se',
            'li', 'fo', 'mi', 'co', 'ilo', 'gan', 'bo', 'frr', 'glk', 'rue',
            'bcl', 'nds-nl', 'fiu-vro', 'or', 'mrj', 'ps', 'tk', 'vls', 'xmf',
            'gv', 'diq', 'zea', 'kv', 'km', 'mhr', 'pag', 'csb', 'vep', 'dv',
            'hak', 'nrm', 'rm', 'koi', 'udm', 'stq', 'so', 'lad', 'sc', 'wuu',
            'zh-classical', 'lij', 'ay', 'ug', 'fur', 'mt', 'pi', 'nov', 'bh',
            'ksh', 'eml', 'as', 'gn', 'kw', 'pcd', 'gag', 'ang', 'ace', 'nv',
            'szl', 'ext', 'frp', 'ie', 'mwl', 'ln', 'sn', 'pfl', 'lez', 'krc',
            'haw', 'pdc', 'xal', 'crh', 'rw', 'dsb', 'kab', 'to', 'myv', 'arc',
            'kl', 'bjn', 'pap', 'kbd', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'srn', 'ty', 'kg', 'bxr', 'ab', 'na', 'tet', 'ltg',
            'ig', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy', 'cu', 'chr', 'tn',
            'cdo', 'roa-rup', 'bi', 'pih', 'got', 'sm', 'bm', 'iu', 'ss', 'sd',
            'pnt', 'ki', 'tyv', 'ee', 'rn', 'ha', 'om', 'fj', 'ti', 'ak', 'ts',
            'ks', 'tw', 'sg', 'ff', 've', 'cr', 'st', 'dz', 'tum', 'ik', 'xh',
            'lg', 'ny', 'ch',
        ]
