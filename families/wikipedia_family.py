...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'new', 'pms', 'tl', 'be', 'ta', 'ht', 'te', 'be-x-old', 'cy', 'lv',
            'bs', 'hy', 'br', 'sq', 'tt', 'jv', 'mg', 'mr', 'lb', 'is', 'my',
            'ml', 'yo', 'ba', 'an', 'lmo', 'af', 'fy', 'pnb', 'bn', 'sw', 'io',
            'bpy', 'ky', 'ur', 'ne', 'scn', 'zh-yue', 'gu', 'nds', 'ga', 'ku',
