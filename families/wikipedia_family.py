...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            'en', 'nl', 'de', 'sv', 'fr', 'it', 'ru', 'es', 'vi', 'war', 'pl',
            ...
            'be-x-old', 'ht', 'ur', 'bs', 'sq', 'br', 'jv', 'mg', 'lb', 'mr',
            'ce', 'is', 'ml', 'pnb', 'ba', 'af', 'my', 'lmo', 'yo', 'ga',
            'zh-yue', 'bn', 'fy', 'an', 'cv', 'tg', 'ky', 'sw', 'ne', 'io',
            'gu', 'bpy', 'sco', 'scn', 'nds', 'ku', 'ast', 'qu', 'su', 'als',
            'gd', 'kn', 'am', 'ia', 'nap', 'bug', 'ckb', 'bat-smg', 'wa',
            'map-bms', 'mn', 'arz', 'mzn', 'zh-min-nan', 'si', 'pa', 'yi',
            'sah', 'vec', 'sa', 'fo', 'bar', 'nah', 'os', 'roa-tara', 'pam',
            'hsb', 'or', 'se', 'li', 'mrj', 'mi', 'ilo', 'co', 'hif', 'gan',
            'frr', 'bo', 'rue', 'glk', 'mhr', 'bcl', 'nds-nl', 'fiu-vro', 'ps',
            'tk', 'pag', 'vls', 'gv', 'xmf', 'diq', 'km', 'kv', 'zea', 'csb',
            'crh', 'vep', 'hak', 'ay', 'dv', 'so', 'sc', 'zh-classical', 'nrm',
            'rm', 'udm', 'koi', 'ug', 'kw', 'lad', 'stq', 'wuu', 'lij', 'fur',
            'eml', 'mt', 'bh', 'as', 'nov', 'cbk-zam', 'pi', 'gn', 'ksh', 'pcd',
            'gag', 'ang', 'szl', 'nv', 'ie', 'ace', 'ext', 'frp', 'mwl', 'ln',
            'sn', 'dsb', 'lez', 'pfl', 'krc', 'haw', 'pdc', 'xal', 'kab', 'rw',
            'myv', 'to', 'arc', 'kl', 'bjn', 'kbd', 'pap', 'lo', 'tpi', 'lbe',
            'wo', 'av', 'mdf', 'jbo', 'na', 'bxr', 'ty', 'srn', 'ig', 'nso',
            'kg', 'tet', 'kaa', 'ab', 'ltg', 'za', 'zu', 'ha', 'tyv', 'chy',
            'rmy', 'cu', 'chr', 'tn', 'cdo', 'roa-rup', 'tw', 'got', 'bi',
            'pih', 'sm', 'bm', 'ss', 'iu', 'sd', 'pnt', 'ki', 'om', 'xh', 'rn',
            'ts', 'ee', 'ak', 'fj', 'ti', 'ks', 'lg', 'sg', 'ny', 'ff', 've',
            'cr', 'st', 'dz', 'tum', 'ik', 'ch',
        ]
