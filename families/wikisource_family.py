...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'vec', 'tr', 'ja', 'eo', 'br', 'yi', 'mk', 'gu', 'uk', 'is', 'ta',
        ...
        # Override defaults
        self.namespaces[829]['sah'] = [u'Обсуждение модуля']
        self.namespaces[828]['sah'] = [u'Модуль']
        ...
        self.namespaces[829]['vec'] = [u'Discussioni modulo']
        self.namespaces[828]['vec'] = [u'Modulo']
