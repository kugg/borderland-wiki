...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ta', 'nl', 'ku', 'de', 'kn', 'vi', 'fi', 'io', 'hu', 'pt', 'ml',
            'no', 'my', 'id', 'it', 'es', 'li', 'et', 'ja', 'te', 'fa', 'ro',
            'cs', 'ar', 'eu', 'jv', 'ca', 'gl', 'lo', 'uk', 'fj', 'br', 'bg',
            'eo', 'hr', 'oc', 'is', 'vo', 'th', 'zh-min-nan', 'simple', 'cy',
            'ps', 'scn', 'sr', 'af', 'ast', 'sw', 'fy', 'tl', 'he', 'nn', 'da',
            'uz', 'ur', 'wa', 'la', 'hy', 'sq', 'sm', 'nah', 'sl', 'hi', 'ka',
            'pnb', 'az', 'tt', 'bs', 'lv', 'lb', 'tk', 'hsb', 'kk', 'sk', 'km',
            'nds', 'mk', 'be', 'ga', 'wo', 'ms', 'ang', 'ky', 'co', 'gn', 'mr',
            'csb', 'st', 'ia', 'sa', 'sd', 'si', 'sh', 'tg', 'ug', 'mn', 'kl',
            'jbo', 'or', 'an', 'ln', 'zu', 'fo', 'gu', 'kw', 'gv', 'rw', 'qu',
        ...
        self.namespaces[3]['eo'] = [u'Uzanta diskuto', u'Vikipediista diskuto', u'Uzula diskuto', u'Uzanto-Diskuto', u'Uzantino-Diskuto']
