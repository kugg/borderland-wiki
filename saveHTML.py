...
def main():
    ...
    for article in sa:
        ...
        if not overwrite_articles and os.path.isfile(
                output_directory + filename + ".txt"):
        ...
        if save_images:
            ...
            for i in images:
                if not overwrite_images and os.path.isfile(
                        output_directory + i['image']):
